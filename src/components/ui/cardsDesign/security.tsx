...
<div className="w-full h-full perspective-[1200px] flex items-center justify-center p-2">
  <motion.div 
    ...
    className="w-full h-full rounded-2xl lg:rounded-3xl p-2 sm:p-3 lg:p-4
  ...
  <div className="flex flex-col w-full gap-1.5 sm:gap-2 lg:gap-3">
      <motion.div 
        ...
        className="flex items-center bg-[rgba(255,255,255,.05)] rounded-lg lg:rounded-xl p-2 sm:p-3 border border-primary/40 shadow-sm min-h-[2.5rem] sm:min-h-[3rem]"
      >
        <motion.div 
          whileHover={{ 
            scale: 1.1,
