...
export default function Booknow() {
  return (
    <>
    <div className="overflow-hidden border-1 bg-[rgba(255,255,255,.03)]">
      <div id="book" className="scroll-mt-35 border-2 md:mx-5 mx-0  bg-[rgba(255,255,255,.04)] py-25 rounded-xl rotate-90">
  <div className="relative h-full bg-black rounded-4xl overflow-hidden -rotate-90">
